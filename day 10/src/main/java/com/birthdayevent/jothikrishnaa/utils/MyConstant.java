package com.birthdayevent.jothikrishnaa.utils;
...
public class MyConstant {
    ...
    public static final String INSERTADDON="/insert";
    public static final String GETADDOn="/get";
    public static final String FOODMENU="/api/v1/foodmenu";
    public static final String POSTMENU="/food";
  ...
  public static String SWAGGER_DESCRIPTION="Produce a Json Web Token";
    public static final List<String> METHODS=Arrays.asList(GET.name(),POST.name(),PUT.name(),PATCH.name(),DELETE.name());
}
