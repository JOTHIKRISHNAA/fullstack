...
//           </p>
//           <p className="user-profile-paragraph">
//             <strong className="user-profile-strong">Phone number:</strong> {user.email}
//           </p>
//           <p className="user-profile-paragraph">
//             <strong className="user-profile-strong">Location:</strong> {user.email}
//           </p>
//           <p className="user-profile-paragraph">
...
import './profile.css'; 
import CustomNavBar from './CustomNavBar';
import userIcon from '../Images/image09.png';
...
const Profile = () => {
  ...
  return (
    ...
    <div className="user-profile-container" style={{width:500}}>
      ...
      <img src={userIcon} alt="User Icon" className="user-icon" /> {/* User icon */}
      </div>
      <h1 className="user-profile-heading" style={{textAlign:'center'}}>User Profile</h1>
      <br></br>
      <br></br>
